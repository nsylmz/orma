...
public class SayimReader {
	...
	public static void main(String[] args) throws IOException {
		readSayim("D:\\Enes\\Springsource\\test data\\input\\SAYIM0213.xls", null);
	}
	
	public static SayimDokuman readSayim(String filePath, String sheetName) throws IOException {
		...
		System.out.println(stream.toXML(sayimDokuman));
		return sayimDokuman;
	}
